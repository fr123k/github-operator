...
"""
import argparse, subprocess, re, shutil
...
for content in contents:
    ...
    kind=kind.lower()
    # skip namespace file
    if kind == "namespace" or kind == "serviceaccount" or kind == "service" or kind == "deployment":
        continue
    ...
    content=re.sub(".*namespace: github-action-secret-operator-system.*\n?", '', content)
